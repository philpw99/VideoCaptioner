...
class BaseASR:
    ...
    allow_running = [True]  # Interrupt the process gracefully
    ...
    def run(self, callback=None, allow_running = None, **kwargs) -> ASRData:
        if allow_running:
    ...
    def _run(self, callback=None, allow_running=None, **kwargs) -> dict:
