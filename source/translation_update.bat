...
C:\Qt\Tools\QtDesignStudio\qt6_design_studio_reduced_version\bin\lupdate -extensions py -noobsolete .\app\ -ts .\resource\translations\VideoCaptioner_zh_HK.ts
C:\Qt\Tools\QtDesignStudio\qt6_design_studio_reduced_version\bin\lupdate -extensions py -noobsolete .\app\ -ts .\resource\translations\VideoCaptioner_ja_JP.ts
Pause